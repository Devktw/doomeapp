...
public class adapter_nes_ep_re extends RecyclerView.Adapter<adapter_nes_ep_re.CustomViewHolder> {
	...
	private static adapter_nes_ep_re instance;
	private int globalPosition = 0;
	boolean isclick=false;
	boolean isfirst=true;
	String premium;
    public adapter_nes_ep_re(Context context, List<JSONEp> feedItemListEp) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.lis_item_ep_re, null);
    ...
    public void onBindViewHolder(final CustomViewHolder customViewHolder,final int position) {
		...
		if(position==statese)
		{
			...
			final SharedPreferences mySharedPreferences = mContext.getSharedPreferences("myep_name", Context.MODE_PRIVATE);
			SharedPreferences.Editor editor = mySharedPreferences.edit();
			editor.putString("epname",jsonDataEp.getEp_name());
			editor.putString("ep",jsonDataEp.getEp());
			editor.commit();
	...
	public static adapter_nes_ep_re getInstance() {
        return instance;
    }
