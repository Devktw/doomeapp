...
public class adapter_nesmangarecon extends RecyclerView.Adapter<adapter_nesmangarecon.CustomViewHolder> {
    private List<model_mangarecom> feedItemList2;
    ...
    public adapter_nesmangarecon(Context context, List<model_mangarecom> feedItemList2) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_mangarate, null);
    ...
    public void onBindViewHolder(final CustomViewHolder customViewHolder,final int position) {
        final model_mangarecom jsonData2 = feedItemList2.get(position);
		...
		customViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					final model_mangarecom json2 = feedItemList2.get(position);
