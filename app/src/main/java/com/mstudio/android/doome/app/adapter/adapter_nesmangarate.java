...
public class adapter_nesmangarate extends RecyclerView.Adapter<adapter_nesmangarate.CustomViewHolder> {
    private List<model_mangarate> feedItemList2;
    private Context mContext;
	private final static int FADE_DURATION = 1000; //FADE_DURATION in milliseconds
	boolean isclick;
    private OnItemClickListener onItemClickListener;

    public adapter_nesmangarate(Context context, List<model_mangarate> feedItemList2) {
    ...
    public void onBindViewHolder(final CustomViewHolder customViewHolder,final int position) {
        final model_mangarate jsonData2 = feedItemList2.get(position);
		...
		customViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					final model_mangarate json2 = feedItemList2.get(position);
