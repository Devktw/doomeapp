...
public class adapter_nes_general extends RecyclerView.Adapter<adapter_nes_general.CustomViewHolder> {
    private List<JSONData> feedItemList2;
    ...
    public adapter_nes_general(Context context, List<JSONData> feedItemList2) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_general, null);
    ...
    public void onBindViewHolder(final CustomViewHolder customViewHolder,final int position) {
        final JSONData jsonData2 = feedItemList2.get(position);
		...
		customViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					final JSONData json2 = feedItemList2.get(position);
