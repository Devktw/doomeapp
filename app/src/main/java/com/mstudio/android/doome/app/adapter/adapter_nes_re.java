...
public class adapter_nes_re extends RecyclerView.Adapter<adapter_nes_re.CustomViewHolder> {
    private List<JSONData3> feedItemList3;
    private Context mContext;
	private final static int FADE_DURATION = 1000; //FADE_DURATION in milliseconds
	private static adapter_nes_re instance;
    private OnItemClickListener onItemClickListener;
	private boolean isclick= false;
    public adapter_nes_re(Context context, List<JSONData3> feedItemList3) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_re, null);
	...
	public static adapter_nes_re getInstance() {
        return instance;
    }
